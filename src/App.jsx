...
const DeckMotif = ({deck}) => {
  ...
  if(deck==="fastgoodcuisine") return <svg style={{position:"absolute",inset:0,width:"100%",height:"100%",pointerEvents:"none"}}><defs><pattern id="dmfgc" width="48" height="48" patternUnits="userSpaceOnUse"><circle cx="9" cy="11" r="1.15" fill="rgba(235,165,180,.16)"/><circle cx="32" cy="19" r="0.85" fill="rgba(224,31,42,.07)"/><circle cx="24" cy="38" r="1" fill="rgba(15,107,88,.075)"/><circle cx="41" cy="8" r="0.7" fill="rgba(255,145,40,.11)"/><circle cx="18" cy="28" r="0.55" fill="rgba(232,140,155,.12)"/></pattern></defs><rect fill="url(#dmfgc)" width="100%" height="100%"/></svg>;

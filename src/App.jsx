...
r:t=><div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"65vh",textAlign:"center"}}><div style={{display:"flex",alignItems:"center",gap:24,marginBottom:32}}><FarLogo size={80} variant={t.lv}/><div style={{width:1,height:36,background:t.brd}}/><img src={pu("/fgc.webp")} alt="Fast Good Cuisine" style={{width:78,height:"auto",borderRadius:12,border:`1px solid ${t.brd}`,boxShadow:t.cS||"none"}}/></div><div style={{...mo,fontSize:11,fontWeight:600,letterSpacing:2.5,padding:"7px 14px",background:t.pill,borderRadius:6,display:"inline-block",color:t.d}}>[MARQUE] × FASTGOODCUISINE</div></div>},
...
r:t=><div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"60vh",textAlign:"center"}}><div style={{display:"flex",alignItems:"center",gap:18,marginBottom:28}}><FarLogo size={72} variant={t.lv}/><div style={{width:1,height:28,background:t.brd}}/><img src={pu("/toinelag-avatar.png")} alt="Toinelag" style={{width:64,height:64,borderRadius:16,objectFit:"cover",border:`3px solid ${t.c}`,boxShadow:t.cS}}/></div><div style={{...mo,fontSize:11,fontWeight:600,letterSpacing:2.5,padding:"7px 14px",background:t.card,borderRadius:8,border:`1px solid ${t.brd}`,display:"inline-block",color:t.d}}>[MARQUE] × TOINELAG</div></div>},
